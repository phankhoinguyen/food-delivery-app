...
class MyColor {
  ...
  static const secondaryBackground = Color.fromARGB(159, 237, 225, 225);
  static const viewAllBackground = Color(0xFFE3F2FD);
  static const imageBackground = Color(0xFFffeecb);
  static const imageBackground2 = Color(0xFFf8e0b1);
